    ...
    <div class="row">
        <div class="col-md-9 mb10 pr-3">
            ...
            <div class="row">
                <div class="col-md-12 mb-3 bg-warning text-dark rounded">
                    <strong><h2 class="text-center">
                        Các bài viết {{$category_name->category_name}}</h2></strong>
                </div>
            </div>
        ...
        <!-- post list -->
            <div class="container">
                <div class="col-md-12 col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
                                <div class="post-type post-img">
                                    <a href="{{URL('/bai-viet/'.$post->post_id)}}">
                                        <img src="{{asset('public/uploads/post/'.$post->post_thumbnail)}}" class="img-responsive" alt="{{$post->post_title}}">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 px-3 py-1">
                                <div class="caption">
                                    <h3 class="md-heading"><b><a href="{{URL('/bai-viet/'.$post->post_id)}}">{{$post->post_title}}</a></b></h3>
                                    <span>
                                            <?php
                                            ...
                                            ?>
                                            {{date(', d-m-Y', strtotime($post->created_at))}} | {{$post->post_view}} lượt xem
                                    </span>
                                    <p>
                                        <strong>
                                             {{$post->post_meta_desc}} 
                                    ...
                                    <a class="btn btn-primary" href="{{URL('/bai-viet/'.$post->post_id)}}" role="button">Xem thêm >></a>
                                </div>
                            </div>
                        </div>
                    </article>
                    ...
                    @if($list_post != null)
                        <article class="post vt-post">
                            <div class="col-md-12 mb-3 pt-2 bg-white text-dark rounded">
                            <strong><h4 class="text-center">
                                Chưa có bài viết</h4></strong></div>
                        </article>
                    @endif

                    <!-- {{$list_post->links()}} -->
                    @if ($list_post->hasPages())
                    <div class="pagination-wrap">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            @if ($list_post->onFirstPage())
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1">Previous</a>
                                </li>
                            @else
                                <li class="page-item"><a class="page-link" href="{{ $list_post->previousPageUrl() }}">Previous</a></li>
                            @endif
                            ...
                            @if (session('orders')->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $list_post->nextPageUrl() }}" rel="next">Next</a>
                                </li>
                            @else
                                <li class="page-item disabled">
        ...
        <!-- end post list -->
            ...
            <div class="row">
                <div class="col-md-12 mb-3 bg-warning text-dark rounded">
                    <strong><h2 class="text-center">
                        Các bài viết nổi bật</h2></strong>
                </div>
            </div>
                ...
                <div class="row">
                    <!-- card -->
                        ...
                        <div class="box-product">
                            ...
                            <div class="header">
                                <h2>Bài viết <strong>nổi bật</strong></h2>
                            </div>
                            <div class="body">
                                <h3 class="m-t-0 m-b-5"><a href="blog-details.html">Apple Introduces Search Ads Basic</a></h3>
                                <ul class="meta-post">
                                    <li><a href="javascript:void(0);"><i class="fa fa-account col-blue"></i>Posted By: John Smith</a></li>
                                    <li><a href="javascript:void(0);"><i class="fa fa-label col-amber"></i>Technology</a></li>
                                    <li><a href="javascript:void(0);"><i class="fa fa-comment-text col-blue"></i>Comments: 3</a></li>
                                </ul>
                            </div>
                            <div class="body">
                                <div class="img-post m-b-15">
                                    ...
                                    <div class="social_share">
                                        <button class="btn btn-primary btn-icon btn-icon-mini btn-round"><i class="fa fa-facebook"></i></button>
                                        <button class="btn btn-primary btn-icon btn-icon-mini btn-round"><i class="fa fa-twitter"></i></button>
                                        <button class="btn btn-primary btn-icon btn-icon-mini btn-round"><i class="fa fa-instagram"></i></button>
                                    </div>
                                </div>
                                <p>okokok</p>
                                <a href="blog-details.html" title="Xem thêm" class="btn btn-round btn-primary">Xem thêm</a>
                            </div>
                        </div>
                        </div>
                        </div>
            ...
            <div class="mb10 bg-white rounded p-2">
                <form class="mb-3">
                    <div class="input-group">
                        ...
                        <button class="input-group-addon rounded" id="basic-addon2"><i class="fa fa-search"></i></button>
                    </div>
                </form>
                ...
                <ul class="list-unstyled categories">
                    @foreach($category_post as $key => $cate)
                        @if($cate->category_id == $category_name->category_id)
                        <li class="active">
                            <a href="#">
                                {{$cate->category_name}}
                            </a>
                        ...
                        <li class="media mb-4">
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <img class="d-flex mr-3 img-fluid" width="64" src="{{asset('public/uploads/post/'.$post->post_thumbnail)}}" alt="{{$post->post_title}}">
                                </div>
